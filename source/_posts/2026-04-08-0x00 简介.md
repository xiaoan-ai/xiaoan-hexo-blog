...
其中原理示意图
![Cobalt Strike ](/images/notes/第四节[DNS Beacon]/images/1.png)
...
![Cobalt Strike ](/images/notes/第四节[DNS Beacon]/images/2.png)
...
![Cobalt Strike ](/images/notes/第四节[DNS Beacon]/images/3.png)

可以看到它通过ns记录 找到了我们的服务器ip ，成功后我们就可以配置我们的监听器了

![Cobalt Strike ](/images/notes/第四节[DNS Beacon]/images/4.png)
这里最好填域名 也就是A记录

![Cobalt Strike ](/images/notes/第四节[DNS Beacon]/images/5.png)

然后确定填上ns记录 英文逗号隔开 ，然后生成马儿测试效果

![Cobalt Strike ](/images/notes/第四节[DNS Beacon]/images/6.png)
