...
![image-20230719085344004](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/1.png)
...
![image-20230719085854180](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/2.png)
...
![image-20230719090127314](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/3.png)
...
![image-20230719090432468](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/4.png)

![image-20230719090640074](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/5.png)

## 3.2. 无插件

登陆进去后，会发现右上角有提示，显示没有插件，不要问我怎么有中文，翻译插件懂么？

![image-20230719090748330](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/6.png)
...
![image-20230719092605147](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/7.png)
...
![image-20230719093201514](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/8.png)
...
![image-20230719093329775](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/9.png)
...
![image-20230719093420947](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/10.png)
...
![image-20230719093923566](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/11.png)
...
![image-20230719094338941](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/12.png)
...
![image-20230719094556640](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/13.png)
...
![image-20230719094818313](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/14.png)
...
![image-20230719094930741](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/15.png)

## 3.5. 查看更新进度

这里再去登陆进去后，再右上角会有一个小圆圈，鼠标放上去就能够看到进度是多少了，等待吧，短则半小时，长则1个小时。

![image-20230719091732329](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/16.png)

## 3.6. 编译完成

编译完成后就会显示插件完成编译。

![image-20230719101412908](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/17.png)
...
![image-20230719101545056](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/18.png)

![image-20230719101607894](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/19.png)

## 4.2. 开始扫描

这里输入名字，描述无所谓要不要输入，输入目标的IP地址即可，下面那个可以下来直接扫描，也可以点击保存，自动跳转后页面点击类似暂停的图标就可以开始扫描了。

![image-20230719101659279](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/20.png)

![image-20230719101712703](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/21.png)

## 4.3. 扫描结果

点进去后就可以看到漏洞情况了，这里自行学习吧，而且nessus是根据版本来进行基本判断是否存在漏洞，所以有时候，就算有漏洞，也可能存在无法利用的情况，可以手动复测等。

![image-20230719101958833](/images/notes/扫描器-ubuntu20.04部署Nessus_pro2023年6月30日版本/images/22.png)
