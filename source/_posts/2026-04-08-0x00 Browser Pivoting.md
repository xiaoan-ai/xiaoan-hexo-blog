...
![Cobalt Strike ](/images/notes/第十一节[Beacon 浏览器劫持与端口扫描]/images/1.png)

选择你要注入的进程

![Cobalt Strike ](/images/notes/第十一节[Beacon 浏览器劫持与端口扫描]/images/2.png)

然后在浏览器设置代理，访问网址

![Cobalt Strike ](/images/notes/第十一节[Beacon 浏览器劫持与端口扫描]/images/3.png)
...
![Cobalt Strike ](/images/notes/第十一节[Beacon 浏览器劫持与端口扫描]/images/4.png)

可以选择网段、协议、以及最大链接数

![Cobalt Strike ](/images/notes/第十一节[Beacon 浏览器劫持与端口扫描]/images/5.png)

扫描完成后我们可以在第三个视图看打我们的扫描结果，多选或者单选 右键 > Services 看到我们的扫描结果。

![Cobalt Strike ](/images/notes/第十一节[Beacon 浏览器劫持与端口扫描]/images/6.png)
