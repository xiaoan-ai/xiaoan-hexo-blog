...
![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/1.jpg) 
...
![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/2.jpg) 

### 2.1.2.**开启代理**

这里开启浏览器的代理，至于代理地址，需要看你设置的是什么，如果是从零开启，并且是看我的安装文章并且更具步骤进行安装的，那么就是127.0.0.1:8080，正常设置也都是这个地址。

![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/3.jpg) 

### 2.1.3.**下载证书**

这里就需要在开启代理的浏览器中输入http://burp即可跳出一个窗口，然后点击CA Certificate即可下载证书，这里如果打不开，需要注意burp软件是否开启的拦截。

![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/4.jpg) 

### 2.1.4.**证书**

通过上面的下载你会得到一个证书。

![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/5.jpg) 
...
![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/6.jpg) 

### 2.2.2.**导入证书**

这里只需要选择我们之前下载下来的证书即可，然后勾选信任即可，当然你全勾选上也可以。

![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/7.jpg) 

![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/8.jpg) 

### 2.2.3.**确认安装**

这里只需要在证书列表中看到有PortSwigger CA即可。

![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/9.jpg) 
...
![img](/images/notes/综合工具-burpsuite安装HTTPS证书/images/10.jpg) 
