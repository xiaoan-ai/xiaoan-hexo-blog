...
![Cobalt Strike ](/images/notes/第九节[Beacon 键盘记录,屏幕截图]/images/1.png)
然后我们选择一个进程来注入 
...
![Cobalt Strike ](/images/notes/第九节[Beacon 键盘记录,屏幕截图]/images/2.png)

不得不说Cobalt Strike还是比较人性化，他给我们提供了很方便的操作，能多选目标 然后右键 获取进程注入键盘记录，屏幕截屏等。

![Cobalt Strike ](/images/notes/第九节[Beacon 键盘记录,屏幕截图]/images/3.png)
...
```
同样 也是可以使用批量的
![Cobalt Strike ](/images/notes/第九节[Beacon 键盘记录,屏幕截图]/images/4.png)
操作跟键盘记录一样，但是选择后他会选择一个记录多长时间，自己按需求选择

我们在 View>Screenshost 可以看到 效果
![Cobalt Strike ](/images/notes/第九节[Beacon 键盘记录,屏幕截图]/images/5.png)
