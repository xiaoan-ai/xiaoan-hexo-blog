...
![img](/images/notes/综合工具-burpsuite/images/3.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/4.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/5.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/6.jpg) 

#### 2.2.1.4.**安装测试**

打开CMD以管理员启动，输入：java -version，若显示版本则证明安装成功。

![img](/images/notes/综合工具-burpsuite/images/7.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/8.jpg) 

然后将左边的内容复制到右边点击下一步。

![img](/images/notes/综合工具-burpsuite/images/9.jpg) 

选择手动激活。

![img](/images/notes/综合工具-burpsuite/images/10.jpg) 

然后将右边的内容复制到左边第二行中，当复制过去后，就会出现第三行，然后把第三行内容再复制到右边窗口的最后一行，点击下一步就能够激活了。

![img](/images/notes/综合工具-burpsuite/images/11.jpg) 

## 3.2.**打开测试**

正常在关闭后，想要再次打开只需要点击BurpLoaderKeygen.jar，然后点击Run就可以了，这里不会出现激活。不过好像新版会闪退，暂时还不太清楚，之前一直用的都是老版本。

![img](/images/notes/综合工具-burpsuite/images/12.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/13.jpg) 

### 4.1.2.**浏览器代理设置**

我这里以火狐举例子，直接进入设置搜索代理，设置代理，这里的代理ip和端口要和Burpsuite一样就可以了。

![img](/images/notes/综合工具-burpsuite/images/14.jpg) 

### 4.1.3.**抓包测试**

![img](/images/notes/综合工具-burpsuite/images/15.jpg) 

## 4.2.**界面调整**

刚打开软件会发现界面很大，同时字也比较大。这里就可以去user options>Display去调整到自己合适的界面。

![img](/images/notes/综合工具-burpsuite/images/16.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/17.jpg) 

### 4.3.2.**右键使用**

当然这里还右键还有很多其它的功能。

![img](/images/notes/综合工具-burpsuite/images/18.jpg) 

### 4.3.3.**http hitsory界面使用**

这个界面主要是用来记录请求过的链接。

![img](/images/notes/综合工具-burpsuite/images/19.jpg) 

### 4.3.4.**Options界面使用**

这个界面就是之前提到的修改代理的界面，这个界面的主要功能也就是修改代理这个了。

![img](/images/notes/综合工具-burpsuite/images/20.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/21.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/22.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/23.png) 

![img](/images/notes/综合工具-burpsuite/images/24.jpg) 
...
![img](/images/notes/综合工具-burpsuite/images/25.jpg) 

### 4.6.2.**使用操作**

默认只有一个框，当输入编码内容后，会自动生成另外一个框，用于显示解密后的内容。

![img](/images/notes/综合工具-burpsuite/images/26.jpg) 
