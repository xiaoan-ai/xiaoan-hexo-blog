...
![image-20230413142228728](/images/notes/综合工具-CobaltStrike简介与下载/images/1.png)
...
![image-20230413142247241](/images/notes/综合工具-CobaltStrike简介与下载/images/2.png)
...
![image-20230413142300801](/images/notes/综合工具-CobaltStrike简介与下载/images/3.png)

### 2.1.3. 客户端

客户端这里只需要运行压缩包中的cobaltstrike.exe即可。

![image-20230413142136931](/images/notes/综合工具-CobaltStrike简介与下载/images/4.png)

#### 2.1.3.1. 初始化配置

在弹出的窗口中需要填写主机地址以及密码，这些都是需要和刚刚服务端上设置的一样。至于端口，默认就是50050无需修改，而用户这里可以自己随便设置一个即可，然后就可以连接了。

![image-20230413142324578](/images/notes/综合工具-CobaltStrike简介与下载/images/5.png)

#### 2.1.3.2. 指纹校验

这里我由于连接过，就没有弹出指纹校验，这里我从网上找了一张图片，这里会含有一个SHA256哈希值，主要是防篡改，每一次的创建Cobalt Strike服务端生成的指纹都是不同的。

![image-20230413142335456](/images/notes/综合工具-CobaltStrike简介与下载/images/6.png)

#### 2.1.3.3. 成功运行

当出现这个界面的时候就证明成功运行了。

![image-20230413142351496](/images/notes/综合工具-CobaltStrike简介与下载/images/7.png)
...
![image-20230413142408026](/images/notes/综合工具-CobaltStrike简介与下载/images/8.png)

![image-20230413142417797](/images/notes/综合工具-CobaltStrike简介与下载/images/9.png)

### 3.1.2. 设置监听

输人名称、监听器类型、团队服务器IP地址、监听的端口，然后单击“Save”按钮保存设置。

![image-20230413142427017](/images/notes/综合工具-CobaltStrike简介与下载/images/10.png)
...
![image-20230413142435447](/images/notes/综合工具-CobaltStrike简介与下载/images/11.png)

### 3.2.2. 设置监听

这里需要设置相应的监听，当设置完后就可以点击运行了。

![image-20230413142442942](/images/notes/综合工具-CobaltStrike简介与下载/images/12.png)
...
![image-20230413142455243](/images/notes/综合工具-CobaltStrike简介与下载/images/13.png)
...
![image-20230413142502122](/images/notes/综合工具-CobaltStrike简介与下载/images/14.png)
...
![image-20230413142511460](/images/notes/综合工具-CobaltStrike简介与下载/images/15.png)

## 3.3. 上线

执行完就可以在页面中看到一台机器上线了。在页面中能够显示，外网IP、内网IP、监听器、用户名、机器名、是否有特权、Beacon进程的PID、心跳时间等信息。

![image-20230413142629946](/images/notes/综合工具-CobaltStrike简介与下载/images/16.png)

### 3.3.1. 测试

这里可以对目标主机进行右击执行一些快捷操作，例如点击Interact，执行一些命令。注意执行命令的格式是shell 命令。

![image-20230413142639701](/images/notes/综合工具-CobaltStrike简介与下载/images/17.png)
...
![image-20230413142653586](/images/notes/综合工具-CobaltStrike简介与下载/images/18.png)
...
![image-20230413142701695](/images/notes/综合工具-CobaltStrike简介与下载/images/19.png)

#### 3.4.1.2. 访问URL

这里我由于生成过了，产生的URL是http:192.168.10.20/a.exe。如果刚生成只是需要将弹出中的URL复制出来，让目标机访问下载即可。

![image-20230413142709726](/images/notes/综合工具-CobaltStrike简介与下载/images/20.png)

#### 3.4.1.3. 上线

同样运行完就会在界面中显示有一台主机上线。

![image-20230413142717527](/images/notes/综合工具-CobaltStrike简介与下载/images/21.png)
...
![image-20230413142724393](/images/notes/综合工具-CobaltStrike简介与下载/images/22.png)

#### 3.4.2.2. 设置监听器

这里的监听器还是刚刚那个监听器。点击生成后会让你选择一个路径进行保存，这里我也生成过了，我就不在生成了。

![image-20230413142731357](/images/notes/综合工具-CobaltStrike简介与下载/images/23.png)

#### 3.4.2.3. 运行exe文件

这里需要在目标机上运行文件，至于文件名称，好像是随机的，当然你也可以修改。

![image-20230413142739752](/images/notes/综合工具-CobaltStrike简介与下载/images/24.png)

#### 3.4.2.4. 上线

同样这里运行完后，也会在界面中显示一台主机上线。

![image-20230413142746959](/images/notes/综合工具-CobaltStrike简介与下载/images/25.png)
