...
安全客首发：https://www.anquanke.com/post/id/227818

CDN对抗系列文章项目源地址：https://github.com/bin-maker/BYPASS-CDN/tree/main
...
![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/1.png)

![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/2.png)
...
![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/3.png)

IP历史：

![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/4.png)

子域名：

![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/5.png)

2.Complete DNS（https://completedns.com/）

Complete DNS 拥有超过 22 亿个DNS变更记录，提供API，支持同时进行多域名/IP查询。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/6.png)

3.WhoISrequest （https://whoisrequest.com/）

WhoISrequest 这个网站自2002年以来一直在跟踪和记录DNS历史变更，数据底蕴很足。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/7.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/7.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/8.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/8.png)

5.微步Threatbook（https://x.threatbook.cn/）

Threatbook 微步在线针对 IP、域名 进行综合查询威胁情报、历史记录、子域名解析、DNS解析等等信息，支持 API 查询，非常方便。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/9.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/9.png)

1. Netcraft（https://netcraft.com/）

Netcraft 不用多说了吧，很多人都知道，不过仁者见仁智者见智吧，经过时代的变迁，Netcraft 也不是曾经的那个少年了，这里只是提一下，仅供参考。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/10.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/10.png)

1. Viewdns（https://viewdns.info/）

Viewdns 可以说是非常的简洁直观了，就算你不懂任何英文，我相信你也看的懂，至少你知道在哪里输入对吧。响应速度也是非常快了，首页一目了然，集成了超多的查询功能。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/11.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/11.png)

找你需要的功能查询就好，用网站提供的 API 也可以

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/12.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/12.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/13.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/13.png)

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/14.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/14.png)

1. Dnsdb（https://dnsdb.io/）

Dnsdb 功能非常强大，老平台了，也是我常用平台之一。

搜索前可以先简单学习一下搜索语法：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/15.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/15.png)

觉得难？不想学？那也没关系，站长已经考虑到你这种懒人情况了，首页就有给懒人准备的搜索构造器，十分友好：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/16.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/16.png)

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/17.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/17.png)

10.SubDomainTools（https://ruo.me/sub）

在线子域名查询，支持实时模式和后台模式，不阻塞前端线程，不占CPU，小测试的时候非常方便。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/18.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/18.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/19.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/19.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/20.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/20.png)

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/21.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/21.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/22.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/22.png)

4.Zoomeye

Zoomeye，钟馗之眼，知道创宇打造的宇宙级网络空间搜索引擎，Shodan 侧重于主机设备，Zoomeye 则偏向于 Web 发现。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/23.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/23.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/24.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/24.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/25.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/25.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/26.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/26.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/27.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/27.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/28.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/28.png)

subdomain 功能支持暴力破解模式和非暴力模式，可以只探测 web 服务或者只探测 ip 可解析的子域，另外支持 webhook 数据传递，作为插件端或者分发消息的接收端来使用都非常方便快捷。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/29.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/29.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/30.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/30.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/31.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/31.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/32.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/32.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/33.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/33.png)

同理，我们根据域名指纹搜索 SSL 证书指纹，然后再反查 IP 就可以了。

首先针对目标域名，选择 `Certificates` 证书搜索，结果出来一堆 `有效` 的证书和 `无效` 的证书：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/34.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/34.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/35.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/35.png)

瞬间减少到了 2 个结果，我们逐个点开，然后 sha1 签名反查 IPV4 主机：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/36.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/36.png)

不过很遗憾，两条记录全都没查到：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/37.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/37.png)

这也从侧面说明了，不是所有的网站只有其 `有效` 证书会匹配其 IP 服务器。

于是只能回到最开始，从所有的结果里面依次打开往下反查指纹，最终定位到了真实 IP ：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/38.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/38.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/39.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/39.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/40.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/40.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/41.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/41.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/42.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/42.png)

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/43.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/43.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/44.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/44.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/45.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/45.png)

也可以使用海外的超级ping类的平台在线多国家多地区测试，推荐 https://www.host-tracker.com/v3/check/ ，支持 140 多个地区的 ping 测试，另外支持针对某子域超长期的监控，通过邮件通知，简直太强大了。

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/46.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/46.png)

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/47.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/47.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/48.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/48.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/49.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/49.png)

针对整个互联网的搜索 IP 结果进一步匹配，比如通过 端口、地理位置、banner 特征、反查邮箱、联系方式等等信息，继续精确结果：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/50.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/50.png)

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/51.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/51.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/52.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/52.png)

刷新一下 dnslog ，获得了真实服务器 IP：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/53.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/53.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/54.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/54.png)

IP 正确，子域正确：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/55.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/55.png)

IP 错误，子域正确：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/56.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/56.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/57.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/57.png)

另外可以通过 find-virtual-hosts （https://pentest-tools.com/information-gathering/find-virtual-hosts#）工具来在线快速针对全网数据扫描比对得出结果：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/58.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/58.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/59.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/59.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/60.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/60.png)

另外值得一提的是，渗透过程中同样可以根据 favicon 哈希、子域、IP 的命中，做好指纹排序并整理，另外做一张常见的中间件或者组件指纹哈希表，分类进行资产快速命中：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/61.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/61.png)

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/62.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/62.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/63.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/63.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/64.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/64.png)
...
[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/65.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/65.png)
...
![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/66.png)

喜欢偷懒的同学可以使用在线查询：`https://suip.biz/?act=cloudfail` 已经将此工具集成到了后台，并做了前端 UI 页面供安全信息从业人员在线查询：

[![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/67.png)](https://byaaronluo.github.io/知识库/01.WEB安全/00.信息收集/2.绕过CDN寻找真实IP/CDN 2021 完全攻击指南（一）.images/67.png)

![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/68.png)
...
![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/69.png)

稍等一段时间就可以了，这里也给大家截个图，防止有同学误会工具不可以使用：

![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/70.png)
...
![Alt text](/images/notes/信息收集-CDN对抗完全指南/images/71.png)