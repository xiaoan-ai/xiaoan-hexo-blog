...
![image-20230730081315068](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/1.png)
...
![image-20230730081520670](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/2.png)
...
![image-20230730081834461](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/3.png)
...
![image-20230730065448195](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/4.png)

### 2.1.2. 不同账户同密码测试

我将域内主机切换到webadmin，来进行测试，按照条件，目前是不同的账户，但是密码是相同的，可以看到这里直接就是拒绝访问，当然这里应该是账户密码错误的，这里拒绝访问应该是域控设置权限的问题。

![image-20230730065648186](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/5.png)
...
![image-20230730071648343](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/6.png)
...
![image-20230730072036670](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/7.png)

### 2.2.2. 重放模块攻击

这里就需要使用到SMB重放模块进行攻击，这里看完下面的操作，再看图就能看懂了，同样前提条件就是账号密码相同，才能利用成功，如果不同就无法利用。

![image-20230730080406256](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/8.png)
...
![image-20230730075637984](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/9.png)
...
![image-20230730075652980](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/10.png)
...
![image-20230730085723849](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/11.png)
...
![image-20230730090753655](/images/notes/横向移动—NTLM-Relay重放&Responder中继攻击&Ldap&Ews/images/12.png)
