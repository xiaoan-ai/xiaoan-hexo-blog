...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/1.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/2.jpg) 

### 2.4.3.**运行后门**

这里我们把生成的exe文件发送到目标主机上进行执行，执行后在攻击机上就能够看到上线了。

![img](/images/notes/综合工具-Metasploit工具使用(下)/images/3.jpg) 

### 2.4.4.**成功获得**

这里可以看到成功获取到了权限，那么就可以进行我们下一步的操作了。

![img](/images/notes/综合工具-Metasploit工具使用(下)/images/4.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/5.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/6.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/7.jpg) 

### 3.1.4.**查看当前进程**

这里迁移后我们可以使用getpid查看一下，迁移后的进程ID。

![img](/images/notes/综合工具-Metasploit工具使用(下)/images/8.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/9.jpg) 

通过目标主机上的1.txt文件判断，我们是成功上传了文件。

![img](/images/notes/综合工具-Metasploit工具使用(下)/images/10.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/11.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/12.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/13.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/14.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/15.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/16.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/17.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/18.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/19.jpg) 

#### 3.6.1.2.**查看效果**

这里的图片在当前目录中就能找到。

![img](/images/notes/综合工具-Metasploit工具使用(下)/images/20.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/21.jpg) 

#### 3.6.2.2.**监控效果**

这里可能会比较慢，过一会就能弹出一个屏幕，不过只能看，并不能操作。

![img](/images/notes/综合工具-Metasploit工具使用(下)/images/22.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/23.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/24.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/25.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/26.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/27.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/28.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/29.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/30.jpg) 
...
![img](/images/notes/综合工具-Metasploit工具使用(下)/images/31.jpg) 
