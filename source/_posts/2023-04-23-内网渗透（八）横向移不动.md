---
title: 内网渗透（八）横向移不动 - 海屿-uf9n1x - 博客园
...
![img](https://blog-1313934826.cos.ap-chengdu.myqcloud.com/blog-images/202304231725113.png)

# 横向移动中的文件传输
### 通过文件共享-IPC
执行net share命令，可以获得Windows默认开启的网络共享，其中C$为C盘共享，ADMIN$为系统目录共享，还有一个IPC$共享。

![img](https://blog-1313934826.cos.ap-chengdu.myqcloud.com/blog-images/202304231725763.png)
...
![img](https://blog-1313934826.cos.ap-chengdu.myqcloud.com/blog-images/202304231725831.png)
