...
![img](/images/notes/中间件-Tomcat/images/1.jpg) 
...
![img](/images/notes/中间件-Tomcat/images/2.jpg) 

#### 1.2.3.2.**验证漏洞是否存在**

这里修改请求方式为：PUT /test.jsp/ HTTP/1.1，请求体为：<%out.print("hacker"); %>，然后访问test.jsp。

![img](/images/notes/中间件-Tomcat/images/3.jpg) 

#### 1.2.3.3.**访问test.jsp**

URL：http:ip地址:端口/test.jsp

![img](/images/notes/中间件-Tomcat/images/4.jpg) 
...
![img](/images/notes/中间件-Tomcat/images/5.jpg) 
...
![img](/images/notes/中间件-Tomcat/images/6.jpg) 
...
![img](/images/notes/中间件-Tomcat/images/7.jpg) 
...
![img](/images/notes/中间件-Tomcat/images/8.jpg) 
...
![img](/images/notes/中间件-Tomcat/images/9.jpg) 
...
![img](/images/notes/中间件-Tomcat/images/10.jpg) 

#### 1.4.3.2.**后台管理**

在后台有一个上传war包的地方，这里就是我们用来上传木马的地方，这里我没准备jsp马，我使用msf来进行操作吧。

![img](/images/notes/中间件-Tomcat/images/11.jpg) 

#### 1.4.3.3.**进入模块**

进入msf里面的exploit/multi/http/tomcat_mgr_upload模块。

![img](/images/notes/中间件-Tomcat/images/12.jpg) 

#### 1.4.3.4.**获取shell**

我这边由于使用云服务器，存在反弹的端口不通，可能被拦截了，所以就没有反弹回来。

![img](/images/notes/中间件-Tomcat/images/13.jpg) 
