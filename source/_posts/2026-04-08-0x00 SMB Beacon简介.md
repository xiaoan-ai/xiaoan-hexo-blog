...
![Cobalt Strike ](/images/notes/第三节[SMB Beacon]/images/1.png)
...
![Cobalt Strike ](/images/notes/第三节[SMB Beacon]/images/2.png)

运行成功后 external 可以看到 ∞∞ 这个字符 ，这就是派生的SMB Beacon
当前是连接状态 你可以主Beacon上 用link host链接它 或者unlink host断开它 。

![Cobalt Strike ](/images/notes/第三节[SMB Beacon]/images/3.png)
...
![Cobalt Strike ](/images/notes/第三节[SMB Beacon]/images/4.png)
![Cobalt Strike ](/images/notes/第三节[SMB Beacon]/images/5.png)
