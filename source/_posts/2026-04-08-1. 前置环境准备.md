...
![image-20230628201632132](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/1.png)
...
![image-20230628202056453](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/2.png)

#### 2.1.1.2. 密码抓取

这里我们再去抓取一下密码，以便我们后续的横向移动。

![image-20230628202316728](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/3.png)
...
![image-20230628203445226](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/4.png)
...
![image-20230628205957524](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/5.png)
...
![image-20230628210634213](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/6.png)
...
![image-20230629093251535](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/7.png)

#### 2.2.1.2. 设置代理规则

这里我们设置由于访问192.168.20.\*才使用这个代理。

![image-20230629093344849](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/8.png)
...
![image-20230629093742245](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/9.png)
...
![image-20230629094356688](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/10.png)
...
![image-20230629095540602](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/11.png)
...
![image-20230629114006650](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/12.png)
...
![image-20230629121006764](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/13.png)
...
![image-20230629121908780](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/14.png)

### 4.3.2. 选择目标

这里我就选择这个192.168.20.30作为目标进行横向移动。

![image-20230629121628522](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/15.png)
...
![image-20230629122011896](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/16.png)

### 4.3.4. 查看上线效果

可以看到成功上线，所以关于psexec，说真的，如果socks能够代理成功，那么本地执行挺好的，如果无法，那么就使用cs中自带的这个psexec来执行也不错。

![image-20230629122219291](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/17.png)
...
![image-20230629123643634](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/18.png)
...
![image-20230630093747119](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/19.png)
...
![image-20230630093829528](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/20.png)
...
![image-20230630093924266](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/21.png)
...
![image-20230630095249907](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/22.png)
...
![image-20230630095506307](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/23.png)
...
![image-20230630100632235](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/24.png)
...
![image-20230630101343127](/images/notes/横向移动—Wmi&Smb&CrackMapExec&ProxyChains&Impacket/images/25.png)
