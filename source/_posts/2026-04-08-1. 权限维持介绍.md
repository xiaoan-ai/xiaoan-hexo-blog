...
![image-20230815093118477](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/1.png)
...
![image-20230815093352497](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/2.png)
...
![image-20230815095803441](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/3.png)
...
![image-20230815095239473](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/4.png)

CS中操作的效果。

![image-20230815100330364](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/5.png)
...
![image-20230815100914898](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/6.png)
...
![image-20230815130546478](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/7.png)
...
![image-20230815130725609](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/8.png)

### 4.2.3. 查看同步效果

这里我们查一下，是否已经将dsrm的hash值同步为webadmin用户的hash了。

![image-20230815131407927](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/9.png)
...
![image-20230815132050557](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/10.png)
...
![image-20230815133452200](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/11.png)

### 4.2.6. 查看效果

这里其实就是在域内主机上弹出一个弹窗，借用这个弹窗来执行命令，来访问域控，而当窗口被关闭后，可以下次借用pth攻击，再次调用起来，确保权限的维持。但是缺点也很明显，我需要远程登陆到域控服务器上，否则弹出的弹窗我并不能利用。

![image-20230815133615651](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/12.png)
...
![image-20230815140404077](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/13.png)
...
![image-20230815140811819](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/14.png)
...
![image-20230815141204752](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/15.png)
...
![image-20230815141351086](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/16.png)
...
![image-20230815141545237](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/17.png)

### 5.1.6. 再次测试

这里再次测试是由于再使用dbadmin的时候，未提前将访问的效果展示出来，后续我又补了一张webadmin的权限前后的效果。

![image-20230815142010593](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/18.png)
...
![image-20230815142208956](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/19.png)
...
![image-20230815142621010](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/20.png)
...
![image-20230815153847530](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/21.png)
...
![image-20230815153803909](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/22.png)
...
![image-20230815154009774](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/23.png)

### 6.1.5. 尝试重启

由于Skeleton Key技术是被注入到lsass.exe进程的，所以它只存在内存中，如域控重启，万能密码将失效，这里可以看到我重启后，命令就无法执行了。

![image-20230815154415758](/images/notes/windows权限维持—SSP&HOOK&DSRM&SIDhistory&SkeletonKey/images/24.png)
