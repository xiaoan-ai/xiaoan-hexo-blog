...
![image-20230816095101384](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/1.png)

### 1.1.1. 解决办法

这里去在AD管理中心能够找到这个用户，不过依旧启用不了，但是将密码修改为永不过期就能够解决这个问题了。

![](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/2.png)
...
![image-20230816101942140](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/3.png)
...
![image-20230816102134578](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/4.png)

#### 2.2.1.3. 本地查看隐藏用户

可以看到从本地确实也能够看到隐藏用户，但是你会发现，是无法删除这个用户的，其实这个就是由于之前说的，在单机版中用户的用户组什么都没添加，所以导致无权进行删除。

![image-20230816102301094](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/5.png)
...
![image-20230816102746902](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/6.png)
...
![image-20230816102924521](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/7.png)

#### 2.2.2.3. 本地查看隐藏用户

可以看到这里是可以删除的，而单机版中是直接点击删除就提示禁止删除。

![image-20230816103006793](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/8.png)
...
![image-20230816104558128](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/9.png)

### 3.1.2. 远控读取文件

你运行完会发现，在该软件目录下会创建一个配置文件，届时你使用CS去读取一下这个配置文件就可以了，这个配置文件中会存在账户密码的。

![image-20230816105026286](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/10.png)
...
![image-20230816105411013](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/11.png)
...
![image-20230816110849221](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/12.png)

#### 3.2.1.2. 读取远控文件

这个工具的账号密码文件在`C:\Users\用户名\AppData\Roaming\RustDesk\config\RustDesk.toml`下，不过很可惜，新版的这个工具可能无法读取文件了，老版是还有的。

![image-20230816114956966](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/13.png)

#### 3.2.1.3. 远控桌面

这里可以看到是成功连接上对方的桌面了，但这里由于我是虚拟机，比较卡，所以画面传输的比较慢。

![image-20230816115312100](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/14.png)
...
![image-20230816115736886](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/15.png)
...
![image-20230816120256631](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/16.png)
...
![image-20230816123606176](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/17.png)
...
![image-20230816124845232](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/18.png)
...
![image-20230816125437096](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/19.png)
...
![image-20230816125826566](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/20.png)
...
![image-20230816132234784](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/21.png)
...
![image-20230816133615545](/images/notes/windows权限维持—黄金白银票据&隐藏用户&远控&RustDesk&GotoHttp_num/images/22.png)
